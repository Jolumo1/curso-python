...
print(f"Eliminado: {lista_a.pop(3)}")
lista_b.clear()
...
lista_4 = [5, 2, 8, 1, 9, 4, 2]
lista_4.sort()
print(lista_4)

print(f"El numero 2 aparece {lista_4.count(2)} veces")
print(f"El numero 7 está en la lista? {7 in lista_4}")
